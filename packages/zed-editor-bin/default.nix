...
let
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-y2agVTd+iZPC5M9rtiEHiUG/Fgenq/95ktzacaurjb4=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-mGJAbBrOof44UnLwY6f7ao18hxkBtI2eBqqTeOvnTP8=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-X4sv2eY707rd/pIrNvHArgIQLxainkkVCz5fnYqZ6w8=";
      type = "dmg";
    };
  };
